...
class UploadJSONFile(ToolBase):
    def _execute(self, **kwargs: Any) -> ToolReturnIter:
        ...
        print(f"File content: {uploaded_file.content}")
    ...
    def user_input_requested(self) -> List[UserInputRequest]:
        return [
            UserInputRequest(
                ...
                extra={"file_types": ["json"], "multiple": False},
            ),
        ]

    @property
    def description_for_user(self) -> str:
        return "allows you to upload your data file in JSON format."
