...
from .engine_openai_causality import AzureOpenAICausalityEngine, OpenAICausalityEngine
...
ENGINE_MAP = {
    ...
    # CoT engines:
    OpenAICausalityEngine.get_engine_name(): OpenAICausalityEngine,
    AzureOpenAICausalityEngine.get_engine_name(): AzureOpenAICausalityEngine,
}
